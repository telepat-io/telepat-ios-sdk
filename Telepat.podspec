#
#  Be sure to run `pod spec lint Telepat.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Ovidiu Nitan"
  # s.authors            = { "Ovidiu Nitan" => "ovidiu@appscend.com" }
  # s.social_media_url   = "http://twitter.com/Ovidiu Nitan"
  ...
  s.source       = { :git => "https://github.com/telepat-io/telepat-ios-sdk.git", :tag => "0.0.1" }
